...
import { englishEmotionsIntermediateLessons } from './english/intermediate-emotions';
...
import { englishFoodIntermediateLessons } from './english/intermediate-food';
import { japaneseFoodIntermediateLessons } from './japanese/intermediate-food';
import { koreanFoodIntermediateLessons } from './korean/intermediate-food';
import { chineseFoodIntermediateLessons } from './chinese/intermediate-food';
import { englishSportsLessons } from './english/elementary-sports';
import { japaneseSportsLessons } from './japanese/elementary-sports';
import { koreanSportsLessons } from './korean/elementary-sports';
import { chineseSportsLessons } from './chinese/elementary-sports';
import { englishNatureLessons } from './english/intermediate-nature';
import { japaneseNatureLessons } from './japanese/intermediate-nature';
import { koreanNatureLessons } from './korean/intermediate-nature';
import { chineseNatureLessons } from './chinese/intermediate-nature';
...
async function main() {
  ...
  const enIntermediateLessons = [...englishWorkLessons, ...englishTravelIntermediateLessons, ...englishCultureLessons, ...englishBusinessLessons, ...englishHealthIntermediateLessons, ...englishEmotionsIntermediateLessons, ...englishFoodIntermediateLessons, ...englishNatureLessons];
  ...
  const jaBeginnerLessons = [...japaneseFoodLessons, ...japaneseTravelLessons, ...japaneseDailyLessons, ...japaneseGreetingsLessons, ...japaneseNumbersLessons, ...japaneseShoppingLessons, ...japaneseFamilyLessons, ...japaneseWeatherLessons, ...japaneseHealthLessons, ...japaneseDailyLifeLessons, ...japaneseSelfIntroLessons];
  ...
  const zhBeginnerLessons = [...chineseFoodLessons, ...chineseShoppingLessons, ...chineseDailyLessons, ...chineseGreetingsLessons, ...chineseFamilyLessons, ...chineseNumbersLessons, ...chineseTravelLessons, ...chineseWeatherLessons, ...chineseHealthLessons, ...chineseDailyLifeLessons, ...chineseSelfIntroLessons];
  ...
  const koBeginnerLessons = [...koreanFoodLessons, ...koreanDailyLessons, ...koreanFamilyLessons, ...koreanGreetingsLessons, ...koreanNumbersLessons, ...koreanShoppingLessons, ...koreanTravelLessons, ...koreanWeatherLessons, ...koreanHealthLessons, ...koreanDailyLifeLessons, ...koreanSelfIntroLessons];
  ...
  const enElementaryLessons = [...englishTransportLessons, ...englishTechnologyLessons, ...englishEmotionsLessons, ...englishColorsLessons, ...englishAnimalsLessons, ...englishTimeLessons, ...englishHobbiesElementaryLessons, ...englishSchoolLessons, ...englishSportsLessons];
  ...
  const jaElementaryLessons = [...japaneseSchoolLessons, ...japaneseEmotionsLessons, ...japaneseHobbiesLessons, ...japaneseTechnologyLessons, ...japaneseTransportLessons, ...japaneseColorsLessons, ...japaneseAnimalsLessons, ...japaneseTimeLessons, ...japaneseSportsLessons];
  ...
  const koElementaryLessons = [...koreanEmotionsLessons, ...koreanHobbiesLessons, ...koreanTechnologyLessons, ...koreanTransportLessons, ...koreanSchoolLessons, ...koreanColorsLessons, ...koreanAnimalsLessons, ...koreanTimeLessons, ...koreanSportsLessons];
  ...
  const zhElementaryLessons = [...chineseEmotionsLessons, ...chineseHobbiesLessons, ...chineseTechnologyLessons, ...chineseTransportLessons, ...chineseSchoolLessons, ...chineseColorsLessons, ...chineseAnimalsLessons, ...chineseTimeLessons, ...chineseSportsLessons];
  ...
  const jaIntermediateLessons = [...japaneseWorkLessons, ...japaneseTravelIntermediateLessons, ...japaneseCultureLessons, ...japaneseBusinessLessons, ...japaneseHealthIntermediateLessons, ...japaneseEmotionsIntermediateLessons, ...japaneseFoodIntermediateLessons, ...japaneseNatureLessons];
  ...
  const koIntermediateLessons = [...koreanWorkLessons, ...koreanTravelIntermediateLessons, ...koreanCultureLessons, ...koreanBusinessLessons, ...koreanHealthIntermediateLessons, ...koreanEmotionsIntermediateLessons, ...koreanFoodIntermediateLessons, ...koreanNatureLessons];
  ...
  const zhIntermediateLessons = [...chineseWorkLessons, ...chineseTravelIntermediateLessons, ...chineseCultureLessons, ...chineseBusinessLessons, ...chineseHealthIntermediateLessons, ...chineseEmotionsIntermediateLessons, ...chineseFoodIntermediateLessons, ...chineseNatureLessons];
