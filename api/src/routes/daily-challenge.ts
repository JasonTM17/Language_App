...
const CHALLENGE_POOL: Challenge[] = [
  ...
  { id: 'speaking-3', type: 'speed_round', title: 'Speaking Sprint', titleVi: 'Nói nhanh', description: 'Complete 3 speaking exercises', descriptionVi: 'Hoàn thành 3 bài nói', icon: '🎤', target: 3, xpReward: 40, gemReward: 8, timeLimit: 300, difficulty: 'medium' },
  { id: 'typing-5', type: 'speed_round', title: 'Typing Master', titleVi: 'Bậc thầy gõ phím', description: 'Complete 5 typing exercises with 90%+ accuracy', descriptionVi: 'Hoàn thành 5 bài gõ với độ chính xác 90%+', icon: '⌨️', target: 5, xpReward: 45, gemReward: 9, timeLimit: 600, difficulty: 'medium' },
  { id: 'story-complete', type: 'perfect_lesson', title: 'Story Time', titleVi: 'Giờ đọc truyện', description: 'Complete a story with all questions correct', descriptionVi: 'Hoàn thành truyện với tất cả câu hỏi đúng', icon: '📖', target: 1, xpReward: 50, gemReward: 10, difficulty: 'medium' },
  { id: 'review-streak-10', type: 'vocab_sprint', title: 'Review Champion', titleVi: 'Nhà vô địch ôn tập', description: 'Review 10 flashcards without mistakes', descriptionVi: 'Ôn 10 flashcard không sai lần nào', icon: '🎯', target: 10, xpReward: 55, gemReward: 11, difficulty: 'hard' },
  { id: 'multi-skill', type: 'grammar_master', title: 'All-Rounder', titleVi: 'Toàn diện', description: 'Complete 1 lesson from each skill type', descriptionVi: 'Hoàn thành 1 bài từ mỗi loại kỹ năng', icon: '🌟', target: 4, xpReward: 80, gemReward: 15, difficulty: 'hard' },
  { id: 'early-bird', type: 'speed_round', title: 'Early Bird', titleVi: 'Chim sớm', description: 'Complete any 3 exercises before 8 AM', descriptionVi: 'Hoàn thành 3 bài trước 8 giờ sáng', icon: '🌅', target: 3, xpReward: 35, gemReward: 7, timeLimit: 0, difficulty: 'easy' },
  { id: 'night-owl', type: 'speed_round', title: 'Night Owl', titleVi: 'Cú đêm', description: 'Complete any 3 exercises after 10 PM', descriptionVi: 'Hoàn thành 3 bài sau 10 giờ tối', icon: '🦉', target: 3, xpReward: 35, gemReward: 7, timeLimit: 0, difficulty: 'easy' },
];
